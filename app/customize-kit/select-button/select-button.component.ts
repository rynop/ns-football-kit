...
@Component({
    ...
    <GridLayout width="65" height="65" class="container" [class.active]="selected">
        ...
        <Image width="55" height="54" src="~/images/{{selected?'customize-btn-green.png':'customize-btn-dot.png'}}"></Image>
        ...
        <GridLayout *ngIf="selected" height="16" width="16" style="border-radius:8; background:#7FAA4D;" verticalAlignment="bottom" horizontalAlignment="right">
            <Label text="&#xf00c;" class="fas" style="color:white; font-size: 10;" textAlignment="center" verticalAlignment="center"></Label>
        </GridLayout>
    </GridLayout>`,
